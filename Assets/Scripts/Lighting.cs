...
public static class Lighting {
    ...
    // Propagates natural light straight down from at the given x,z coords starting from the right startY value
    public static void CastNaturalLight(ChunkData chunkData, int x, int z, int startY) {
        ...
        if (startY > VoxelData.ChunkHeight - 1) {
            ...
            Debug.LogWarning("Attempted to cast a natural light from above world");
        }
